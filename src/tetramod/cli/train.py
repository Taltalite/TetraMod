"""
TetraMod entry point for the Bonito-derived train_mod handler.
"""
...
train_mod_default_config = (
    ...
    / "models/configs/multihead_transformer.toml"
)
RUNTIME_CONFIG_KEYS = (
    "basecaller",
    "scaling",
...
def load_pretrained_config(pretrained):
    ...
    return deps["toml"].load(pretrain_file)
